...
CATEGORIES: list[tuple[str, str, list[tuple[str, str]]]] = [
    ...
    ("🃏 Claim, Achat & Collection", "Recrute des joueurs et gère ta collection — partout, tape juste un bout du nom, une liste de suggestions apparaît.", [
        ("/claim", "Réclame un joueur Inazuma aléatoire — aucun cooldown, claim illimité !"),
        ("/buy <nom>", "Achète directement n'importe quel joueur au prix de base (ex: tape `mark` pour Mark Evans)."),
        ("/collection [membre] [poste] [rareté]", "Liste tes joueurs possédés, avec filtres."),
        ("/card <nom>", "Affiche la carte détaillée d'un joueur (recherche par nom)."),
        ("/sell <nom>", "Vend une carte contre des KP (40% du prix de base, recherche par nom)."),
        ("/lock <nom> / /unlock <nom>", "Verrouille/déverrouille une carte contre la vente ou l'échange accidentel."),
    ]),
    ("👕 Équipe", "Compose ta formation, ton onze de départ et ton banc — recherche par nom partout aussi.", [
        ...
        ("/team set <slot> <nom>", "Place une carte dans un slot (titulaire, doit correspondre au poste)."),
        ("/team bench <nom>", "Envoie une carte sur le banc."),
        ("/team remove <slot>", "Vide un slot."),
        ("/team equip <nom joueur> <nom technique>", "Équipe une technique achetée sur un joueur."),
        ("/team unequip <nom>", "Retire la technique équipée."),
        ("/team tactic <nom>", "Équipe une tactique d'équipe possédée."),
        ("/team coach <nom>", "Équipe un coach possédé."),
        ("/team rename <nom>", "Renomme ton équipe."),
    ]),
    ("🏪 Boutique", "Achète techniques, tactiques et coachs avec tes KP — recherche par nom.", [
        ...
        ("/technique <nom>", "Affiche la carte détaillée (avec image générée) d'une technique."),
        ("/coach <nom>", "Affiche la carte détaillée (avec image générée) d'un coach."),
